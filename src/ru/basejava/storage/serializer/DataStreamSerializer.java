    ...
    public void doWrite(Resume r, OutputStream os) throws IOException {
        try (DataOutputStream dos = new DataOutputStream(os)) {
            ...
            writeCollection(dos, r.getSection().entrySet(), section -> {
                ...
                switch (sectionType) {
                    case OBJECTIVE, PERSONAL -> //Write content for sections OBJECTIVE, PERSONAL
                            dos.writeUTF(((TextSection) sectionTypeValue).getDescription());
                    case ACHIEVEMENT, QUALIFICATIONS -> //Write content for sections ACHIEVEMENT, QUALIFICATIONS
                            writeCollection(dos, ((ListSection) sectionTypeValue).getItems(), dos::writeUTF);
    ...
    public Resume doRead(InputStream is) throws IOException {
        try (DataInputStream dis = new DataInputStream(is)) {
            ...
            readCollection(dis, () -> {
                ...
                switch (sectionType) {
                    case OBJECTIVE, PERSONAL -> //Read TextSections and add them to resume
                            resume.addSection(sectionType, new TextSection(dis.readUTF()));
                    case ACHIEVEMENT, QUALIFICATIONS -> //Read ListSections and add them to resume
                    ...
                    case EXPERIENCE, EDUCATION -> {
                        ...
                        readCollection(dis, () -> organizationsList.add(new Organization(new Link(dis.readUTF(), dis.readUTF()),
                                //Read list of positions and add them to resume
